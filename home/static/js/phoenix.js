  ...
  const advanceAjaxTableInit = () => {
    ...
    if (table) {
      ...
      const updateListControls = () => {
        listInfo &&
          (listInfo.innerHTML = `${orderList.i} đến ${numberOfcurrentItems} Trong ${totalItem}`);
    ...
    if (window.List) {
      ...
      if (lists.length) {
        lists.forEach(el => {
          ...
          const updateListControls = () => {
            listInfo &&
              (listInfo.innerHTML = `${list.i} đến ${numberOfcurrentItems} <span class='text-body-tertiary'> Trong </span>${totalItem}`);
          ...
          list.on('updated', item => {
            ...
            if (isSearching) {
              ...
              } <span class='text-body-tertiary'> Trong </span>${
